...
public class Story extends AbstractBasePage {
    ...
    public void clickSaveStory() {
        CommonActions.clickElement(saveStoryButton);
    }
    ...
    private Map<StorySetting, StoryStep> strategyConfigureSetting(
        ...
        strategyMap.put(StorySetting.NAME, () -> insertNameStory(configureMap.get(StorySetting.NAME)));
        strategyMap.put(StorySetting.STORY_TYPE, () -> insertStoryTypeData(configureMap.get(StorySetting.STORY_TYPE)));
        strategyMap.put(StorySetting.POINTS, () -> insertPointData(configureMap.get(StorySetting.POINTS)));
        strategyMap.put(StorySetting.BLOCKERS, () -> insertBlockerData(configureMap.get(StorySetting.BLOCKERS)));
        strategyMap.put(StorySetting.DESCRIPTION, () -> insertDescription(configureMap.get(StorySetting.DESCRIPTION)));
        strategyMap.put(StorySetting.LABEL, () -> insertLabelData(configureMap.get(StorySetting.LABEL)));
    ...
    public void insertNameStory(final String name) {
        CommonActions.setTextField(storyTitleTextField, name);
    }
